          ...
          <div className="space-y-6">
            <div className="prose prose-lg max-w-none"> 
              <p className="text-gray-700 leading-relaxed">
                I'm Prathushna Manepalli, a passionate B.Tech student specializing in
              ...
              <p className="text-gray-700 leading-relaxed">
                Throughout my academic journey, I've maintained a strong CGPA of 7.59 while
                actively participating in internships and projects that have enhanced my
                practical skills in machine learning, and full-stack development.
              </p>

              <p className="text-gray-700 leading-relaxed">
                My interests extend beyond academics to exploring AI technologies,
            ...
            <div className="bg-gradient-card p-6 rounded-lg">
              ...
              <div className="flex flex-wrap gap-3">
                {['Telugu', 'English', 'Spanish'].map((language) => (
                  <span
                    key={language}
