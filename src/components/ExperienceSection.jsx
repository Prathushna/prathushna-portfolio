  ...
  const experiences = [
    {
      ...
      description: "Assisted in developing and maintaining responsive web applications, contributing to front-end and back-end tasks to improve functionality and user experience.",
      tools: ["Front-end", "Back-end", "Cloud"],
    ...
    },
    {
      ...
      tools: ["Event Management", "AI/ML", "Membership"],
            ...
            <Card key={index} className="tech-card group">
              <CardContent className="p-6">
                ...
                {exp.tools && exp.tools.length > 0 && ( 
                  <div>
                    <h5 className="text-sm font-semibold text-gray-900 mb-2">tools Used:</h5>
                    <div className="flex flex-wrap gap-2">
                      {exp.tools.map((skill, i) => (
                        <span
                          key={i}
