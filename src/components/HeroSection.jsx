import profileImage from '../assets/ima.jpg';
          ...
          <div className="space-y-8 animate-slide-up">
            <div>
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-4">
                Prathushna{' '}
                <span className="text-gradient">Manepalli</span>
              </h1>
            ...
            <div className="space-y-3 text-gray-600">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>+91-9248233333</span>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="h-5 w-5 text-blue-600" />
                <span>prathushnamanepalli@gmail.com</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button variant="outline" size="lg" asChild>
                <a
                  href="https://www.linkedin.com/in/prathushna-manepalli-8a453727b/"
                  target="_blank"
              ...
              <Button variant="outline" size="lg" asChild>
                <a
                  href="https://github.com/Prathushna"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center"
                >
